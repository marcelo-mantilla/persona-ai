...
class ActionService(Service):
    ...
    @staticmethod
    def _action_prompt_template(persona_template, avatar_name, date_and_time) -> str:
        """
    ...
    @staticmethod
    def _caption_prompt_template(persona_template, caption_template, action, avatar_name) -> str:
        """
    ...
    @staticmethod
    def _status_prompt_template(persona_template, avatar_name, date_and_time) -> str:
        """
